...
public class Course {
    ...
    public Course(int courseID, String courseName, String courseType, String duration, String no_of_payment, String student_limit, String tax, double course_fee, String discount, String late_payment_added_value) {
