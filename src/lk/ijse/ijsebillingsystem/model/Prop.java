...
public class Prop {
    ...
    public Prop(String server, String user, String database, String DBPassword, String masterPassword, String repeatPassword, String newPassword, String notifyDate, String notifyDateDuration) {
        this.server = server;
        this.user = user;
